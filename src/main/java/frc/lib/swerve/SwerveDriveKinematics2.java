 ...
 * speed. Makes use of {@link BetterSwerveModuleState} to add the angular velocity that is required of the module as an
 * output.
 */
public class SwerveDriveKinematics2 extends SwerveDriveKinematics
{
   ...
   * {@link #desaturateWheelSpeeds(BetterSwerveModuleState[], double) DesaturateWheelSpeeds} function to rectify this issue.
   */
