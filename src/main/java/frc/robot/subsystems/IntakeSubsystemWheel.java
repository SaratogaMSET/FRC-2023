...
//     m_intake = new CANSparkMax(Constants.IntakeConstants.WHEEL_INTAKE_MOTOR, MotorType.kBrushless);
...
//   public void runIntake(Direction direction, double intakeSpeed) {
//     // INTAKE_SPEED = 0.5;  //
