...
public class SwerveModuleIOSim implements SwerveModuleIO {
  ...
  PIDController driveController = new PIDController(Constants.Drivetrain.simDriveKP, 0, 0);
  SimpleMotorFeedforward driveFeedforward =
      new SimpleMotorFeedforward(
          Constants.Drivetrain.simDriveKS, Constants.Drivetrain.simDriveKV, Constants.Drivetrain.simDriveKA);

  PIDController steerController =
      new PIDController(Constants.Drivetrain.simAngleKP, 0, Constants.Drivetrain.simAngleKD);
