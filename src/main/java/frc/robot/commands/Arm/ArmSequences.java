...
public class ArmSequences{
    ...
    public static Command armDunkMiddle(ArmSubsystem armSubsystem, WheelIntake intake,  int side){
        ...
        RunWheelExtakeCommand extake = new RunWheelExtakeCommand(intake, 0.5);
        if(side > 0) {
            // ready = new ArmPositionCommand(armSubsystem, -Constants.ArmNodeDictionary.ready_double_substation_x, Constants.ArmNodeDictionary.ready_double_substation_y, 0.5);
            ...
            dunk = new ArmPositionCommandMiddle(armSubsystem, -(Constants.ArmNodeDictionary.ready_midcone_score_x), Constants.ArmNodeDictionary.ready_midcone_score_y-0.2, 0.1, false);
        ...
        return (((dunk).andThen((reset)).andThen(new ArmZeroCommand(armSubsystem)))).raceWith(extake).andThen(new SetIntakeSpeedCommand(intake, 0.0));
