...
/** Custom version of the Custom PathPlanner version of SwerveControllerCommand */
public class PPSwerveControllerCommandA extends CommandBase {
  ...
  private static BiConsumer<Translation2d, Rotation2d> logError =
      PPSwerveControllerCommandA::defaultLogError;
   ...
   */
  public PPSwerveControllerCommandA(
   ...
   * @param poseSupplier A function that supplies the robot pose - use one of the odometry classes
   *     to provide this.
   * @param kinematics The kinematics for the robot drivetrain. This is using SwerveDriveKinematics2
   * @param xController The Trajectory Tracker PID controller for the robot's x position.
   * @param yController The Trajectory Tracker PID controller for the robot's y position.
   * @param rotationController The Trajectory Tracker PID controller for angle for the robot.
   ...
   *     color? In order for this to work properly, you MUST create your path on the blue side of
   *     the field.
   * @param drivetrainsubsystem Requires the Drivetrain Subsystem
   */
  public PPSwerveControllerCommandA(
      PathPlannerTrajectory trajectory,
      Supplier<Pose2d> poseSupplier,
      SwerveDriveKinematics2 kinematics,
      PIDController xController,
      PIDController yController,
      PIDController rotationController,
      Consumer<ChassisSpeeds> outputChassisSpeeds,
...
@Override
  ...
  public static void setLoggingCallbacks(
    ...
    PPSwerveControllerCommandA.logActiveTrajectory = logActiveTrajectory;
    PPSwerveControllerCommandA.logTargetPose = logTargetPose;
    PPSwerveControllerCommandA.logSetpoint = logSetpoint;
    PPSwerveControllerCommandA.logError = logError;
  }
}
